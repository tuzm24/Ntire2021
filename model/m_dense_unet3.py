...
class GridDenseChannelExt(nn.Module):
    def __init__(self, in_channels, out_channels=256):
        ...
        self.convs = nn.Sequential(
            ...
            nn.PReLU(),
            nn.Conv2d(in_channels=64, out_channels=(128+out_channels)//3, kernel_size=3, stride =2, padding=1, bias=False),
            nn.PReLU(),
...
class MegaDenseUnet(nn.Module):
    def __init__(self, args):
        ...
        self.prelu1 = nn.PReLU()
        self.conv2 = nn.Conv2d(in_channels=self.base_channel, out_channels=self.base_channel, kernel_size=3, stride=2, padding=1, bias=False)
        self.prelu2 = nn.PReLU()

        self.gdce1_1 = nn.Conv2d(in_channels=self.base_channel*2, out_channels=self.base_channel, kernel_size=3, stride=1, padding=1, bias=False)
        self.gdce2_1 = nn.Conv2d(in_channels=self.base_channel*2, out_channels=self.base_channel, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.finalconv = nn.Conv2d(in_channels=self.base_channel//4, out_channels=3, kernel_size=3, stride=1, padding=1, bias=False)
